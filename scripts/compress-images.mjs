...
const slabPngs = [
  'red_multicolor_slab.png', 'tan_brown_slab.png', 'steel_grey_slab.png',
  'viscount_white_slab.png', 'absolute_black_slab.png', 'black_galaxy_slab.png',
  'kashmir_white_slab.png', 'colonial_white_slab.png', 'hero-slabs.png', 'hero-bg.png'
];
...
for (const name of slabPngs) {
  ...
  try {
    ...
    console.log(`  ✅ ${name} (${kb(before)}) → ${outName} (${kb(after)}) | saved ${kb(before - after)}`);
    await unlink(inPath);
  } catch (e) {
...
console.log('\n📦 Re-compressing JPGs...\n');
const jpgFiles = ['factory.jpg', 'shipping.jpg', 'hero-quarry.jpg',
  'project-hotel.jpg', 'project-villa.jpg', 'project-tower.jpg', 'project-monument.jpg',
  'texture-brown.jpg', 'texture-grey.jpg', 'texture-red.jpg', 'texture-white.jpg', 'texture-black.jpg'];
