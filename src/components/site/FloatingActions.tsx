    ...
    <div className="fixed bottom-5 right-5 z-[9999] flex flex-col items-end gap-3">
      {show && (
        <button
          ...
          className="size-10 rounded-full bg-onyx text-bone border border-gold/30 flex items-center justify-center shadow-lg hover:bg-gold hover:text-onyx transition-all duration-500 hover:-translate-y-1"
