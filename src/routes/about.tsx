  ...
  return (
    <>
      <section className="relative h-[70vh] min-h-[480px] bg-onyx overflow-hidden">
        <img src={quarryImg} alt="Indian granite quarry" className="absolute inset-0 h-full w-full object-cover opacity-40" />
        ...
        <div className="relative container-wide h-full flex flex-col justify-end pb-20">
          <div className="flex items-center gap-3 mb-6">
            <span className="hairline" /><span className="eyebrow">About the Company</span>
          </div>
          <h1 className="font-display text-bone text-5xl lg:text-7xl max-w-4xl leading-[1]">
            A professional export company —<br/><span className="text-gold italic font-light">not a marketplace.</span>
          </h1>
        </div>
      </section>
      ...
      <section className="bg-onyx text-bone py-28">
        <div className="container-wide grid gap-16 lg:grid-cols-2 items-center">
          ...
          <Reveal delay={0.1}>
            <div className="flex items-center gap-3 mb-6"><span className="hairline" /><span className="eyebrow">Our Promise</span></div>
            <h2 className="font-display text-4xl lg:text-5xl">Container loads delivered on quality, paperwork, and time.</h2>
