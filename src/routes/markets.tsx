...
const MARKETS = [
  { c: "Germany", slug: "germany", port: "Hamburg · Bremerhaven", note: "Strongest European market. Large kitchen, façade, and monument volumes." },
  { c: "Spain", slug: "spain", port: "Valencia · Barcelona", note: "Hospitality and residential developer projects across the Mediterranean coast." },
  { c: "Italy", slug: "italy", port: "Genoa · Livorno", note: "High-end interiors, hotels, and luxury villa cladding." },
  { c: "France", slug: "france", port: "Le Havre · Marseille", note: "Public infrastructure, hospitality, and residential exports." },
  { c: "Netherlands", slug: "netherlands", port: "Rotterdam", note: "Distribution hub serving Benelux stone wholesalers." },
  { c: "Belgium", slug: "belgium", port: "Antwerp", note: "Memorial and monument trade plus residential projects." },
  { c: "Cyprus", slug: "cyprus", port: "Limassol", note: "Hospitality, resort, and villa construction." },
  ...
  return (
    <>
      <section className="relative pt-40 pb-24 bg-onyx text-bone overflow-hidden">
        <img src={shippingImg} alt="" className="absolute inset-0 h-full w-full object-cover opacity-30" />
